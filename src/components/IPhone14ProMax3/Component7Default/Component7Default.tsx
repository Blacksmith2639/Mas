...
import classes from './Component7Default.module.scss';
...
/* @figmaId 395:3407 */
export const Component7Default: FC<Props> = memo(function Component7Default(props = {}) {
  return (
    <div className={`${resets.clapyResets} ${props.classes?.root || ''} ${props.className || ''} ${classes.root}`}>
      <RS
        ...
        text={{
          _115: <div className={classes._115}>01/15</div>,
          _117: <div className={classes._117}>01/17</div>,
          _120: <div className={classes._120}>01/20</div>,
          _123: <div className={classes._123}>01/23</div>,
          _125: <div className={classes._125}>01/25</div>,
          _25: <div className={classes._25}>02/05</div>,
        }}
      />
